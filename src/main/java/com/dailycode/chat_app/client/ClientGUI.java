...
//import com.dailycode.chat_app.MessageListener;
    ...
    public ClientGUI(String username) throws ExecutionException, InterruptedException {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(ClientGUI.this, "Do You Really to Leave?",
     ...
     private void addConnectedUserComponents(){
      ...
      connectedUsersPanel.setBackground(Utilities.SECONARY_COLOR);
     ...
     private void addChatComponents(){
        ...
        chatPanel.setBackground(Utilities.TRANSPARANTE_COLOR);

        messagePanel = new JPanel();
        messagePanel.setLayout(new BoxLayout(messagePanel,BoxLayout.Y_AXIS));
        messagePanel.setBackground(Utilities.TRANSPARANTE_COLOR);

         messagePanelScrollPane = new JScrollPane(messagePanel);
         messagePanelScrollPane.setBackground(Utilities.TRANSPARANTE_COLOR);
...
// Set the unit increment for the vertical scroll bar
         ...
         inputPanel.setBackground(Utilities.TRANSPARANTE_COLOR);
         ...
         inputField.addKeyListener(new KeyAdapter() {
             ...
             public void keyTyped(KeyEvent e) {
                 if(e.getKeyChar() == KeyEvent.VK_ENTER){
                     ...
                     myStompClient.sendMessage(new Message(username, input)); // If username is a string

                 }
             }
         });
         inputField.setBackground(Utilities.SECONARY_COLOR);
     ...
     private JPanel createChatMessageComponent(Message message){
        ...
        chatMessage.setBackground(Utilities.TRANSPARANTE_COLOR);
    ...
    public void onActiveUsersUpdated(ArrayList<String> users) {
        ...
        userListPanel.setBackground(Utilities.TRANSPARANTE_COLOR);
